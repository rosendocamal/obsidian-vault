...
&= \frac{1}{3} \frac{d}{dx} \left( x^3 \right) + 0 \\
&= \frac{1}{3} \left( 3x^2 \right) \\
&= x^2
$$
...
&= \frac{3}{5} \frac{d}{dx} \left( \sqrt[3]{x^3} \cdot \sqrt[3]{x^2} \right) \\
&= \frac{3}{5} \frac{d}{dx} \left( x^{\frac{3}{3}} \cdot x^{\frac{2}{3}} \right) \\
&= \frac{3}{5} \frac{d}{dx} \left( x^{\frac{5}{3}} \right) \\
&= \frac{3}{5} \cdot \frac{5}{3} x^{\frac{5}{3} - 1} \\
&= x^{\frac{2}{3}}
$$
